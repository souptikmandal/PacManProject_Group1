...
- **pac_man.py**: Implements Pac-Man's movement and interactions.
...
Fill in tests for your code in the corresponding test file (e.g., test_pac_man.py for pac_man.py). Follow the example tests to model your tests.
